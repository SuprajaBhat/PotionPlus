...
import static com.example.signuplab.BMICalcUtil.BMI_CATEGORY_HEALTHY;
import static com.example.signuplab.BMICalcUtil.BMI_CATEGORY_OBESE;
import static com.example.signuplab.BMICalcUtil.BMI_CATEGORY_OVERWEIGHT;
import static com.example.signuplab.BMICalcUtil.BMI_CATEGORY_UNDERWEIGHT;
public class health_tracker extends AppCompatActivity {
            ...
            public void onClick(View view) {
                if (inMetricUnits) {
                    if (weightKgEditText.length() == 0 || heightCmEditText.length() == 0) {
                        Toast.makeText(health_tracker.this, "Populate Weight and Height to Calculate BMI", Toast.LENGTH_SHORT).show();
                    } else {
